...
<div class="print text-right">
    <a onclick='printData();' class="btn btn-success"><i class="fa fa-print"></i> Print</a>   
</div>
<br>
<?php
                    ...
                    foreach ($orders as $tr) {
                        ...
                        <tr>
                            ...
                            <td class="<?= $class ?> text-center" data-action-id="<?= $tr['id'] ?>">
                                ...
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 3)" class="btn btn-danger btn-xs">Returned</a></div>
                            </td>
...
<table class="table table-condensed table-bordered table-striped" style="display: none;" id="printOrders">
                <thead>
                    <tr>
                       <th colspan="4">List of Orders</th> 
                    </tr>
                </thead>
                <thead>
                    <tr>
