...
<footer>Scriptum - Buy the book</footer>
<?php } ?>
</div>
<!-- Modal Calculator -->
...
function printData()
{
   var divToPrint=document.getElementById("printOrders");
   $('#printOrders').css('display','block');
   window.location.href = '<?= base_url('admin/orders?order_by=processed') ?>';
   newWin= window.open("");
