                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($order['processed'] == 3) {
                                            ?>
                                            <button readonly disabled class="btn btn-warning btn-sm">Returned</button>
                                            <?php } else {
                                                ?>
                                                <div style="margin-bottom:4px;"><a href="http://localhost/scriptum/verify/return.php?id=<?= $order['order_id'] ?>" onclick = "if (! confirm('Are you sure you want to return the orders?')) { return false; }" class="btn btn-danger btn-xs">Return Order</a></div>
